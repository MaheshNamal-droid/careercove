        ...
        >
            ...
            <div className="flex">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <BarChart
                    series={[
                        { data: dataArray, label: 'My Vacancies',color: 'rgb(218, 0, 255)' },
                    ]}
                    height={290}
                    width={500}
                    ...
                    <BarChart
                    series={[
                        { data: jobApplicationArry, label: 'My Applications' },
                    ]}
                    height={290}
                    width={500}
                   ...
                   <LineChart
                        series={[
                            { curve: "monotoneY", data: dataArray, label: 'My Vacancies',color: 'rgb(218, 0, 255)' },
                            { curve: "monotoneY", data: jobApplicationArry, label: 'My Applications',color: 'red' },
                        ]}
                        height={290}
                        width={500}
                        xAxis={[{ data: newArray, scaleType: 'band' }]}
